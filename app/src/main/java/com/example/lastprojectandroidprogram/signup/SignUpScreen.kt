package com.example.lastprojectandroidprogram.signup
...
import com.example.lastprojectandroidprogram.Service.registerUser
...
import com.example.lastprojectandroidprogram.login.defaultPadding
import com.example.lastprojectandroidprogram.ui.theme.*
...
fun SignUpScreen(
    ...
    val (name, onFirstNameChange) = rememberSaveable {
        mutableStateOf("")
    }
    ...
    val isFieldsNotEmpty = name.isNotEmpty() && phone.isNotEmpty() &&
    ...
    Column(
        ...
        Button(
            onClick = {
                ...
                if (!isPasswordSame) {
                    registerUser(userName, password, email, phone, object : RegisterCallback{
                        override fun onResult(response: ResponseRegister?) {
                            if (response != null) {
                                Log.d("SignUp", "Registration successful: ${response.username}")
